...
@section('title', 'Update Karir')

@section('content')
    <div class="my-5">
        <form action="/admin/carrier/update" method="post">
            @csrf
            <div class="input-group">
                <label for="in_namacarrier">Nama Pekerjaan</label>
                <input type="text" id="in_namacarrier" name="in_namacarrier" value="" placeholder="isikan nama pekerjaan">
            </div>
            <div class="grid grid-cols-2 gap-10">
                <div class="input-group">
                    <label for="in_minpend">Min. Pedidikan</label>
                    <input type="text" id="in_minpend" name="in_minpend" value="" placeholder="isikan minimal pendidikan">
                </div>
                <div class="input-group">
                    <label for="in_deadline">Penutupan pendaftaran</label>
                    <input type="date" id="in_deadline" name="in_deadline" value="">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-10 mb-5">
                <div class="flex flex-col">
                    ...
                    <div class="flex gap-3 mb-3 items-center">
                        ...
                        <span class="btn-primary"><i class="fa fa-minus"></i></span>
                    </div>
                ...
                <div>
                    ...
                    <div class="flex gap-3 mb-3 items-center">
                        ...
                        <span class="btn-primary" id="min_berkas"><i class="fa fa-minus"></i></span>
                    </div>
            ...
            <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" name="publish" id="publish" value="" class="sr-only peer" onclick="checking()">
                <div
            ...
            <div class="flex gap-5 mt-5">
                ...
                <a href="/admin/carrier"><button class="btn-primary"><span>Batal</span></button></a>
            </div>
